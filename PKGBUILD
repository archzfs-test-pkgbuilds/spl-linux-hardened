...
pkgrel=1
makedepends=("linux-hardened-headers=4.16.6.a-1" "git")
arch=("x86_64")
...
license=("GPL")
depends=("spl-utils-common=0.7.8" "kmod" "linux-hardened=4.16.6.a-1")
...
package_spl-linux-hardened-headers() {
    ...
    sed -i "s+${srcdir}++" ${pkgdir}/usr/src/spl-*/4.16.6-1-hardened/Module.symvers
}
