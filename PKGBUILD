...
pkgrel=1
makedepends=("linux-hardened-headers=4.14.15.a-1" "git")
arch=("x86_64")
...
license=("GPL")
depends=("spl-utils-common=0.7.5" "kmod" "linux-hardened=4.14.15.a-1")
prepare() {
    cd "${srcdir}/spl-0.7.5"
...
package_spl-linux-hardened-headers() {
    ...
    sed -i "s+${srcdir}++" ${pkgdir}/usr/src/spl-*/4.14.15-1-hardened/Module.symvers
}
