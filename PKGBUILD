...
pkgrel=1
makedepends=("linux-hardened-headers=4.16.12.a-1")
arch=("x86_64")
...
license=("GPL")
depends=("spl-utils-common=0.7.9" "kmod" "linux-hardened=4.16.12.a-1")
...
package_spl-linux-hardened-headers() {
    ...
    sed -i "s+${srcdir}++" ${pkgdir}/usr/src/spl-*/4.16.12-1-hardened/Module.symvers
}
