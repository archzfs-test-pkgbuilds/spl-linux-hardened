...
pkgver=0.7.9_4.16.9.a.1
pkgrel=1
makedepends=("linux-hardened-headers=4.16.9.a-1")
arch=("x86_64")
...
license=("GPL")
depends=("spl-utils-common=0.7.9" "kmod" "linux-hardened=4.16.9.a-1")

build() {
    cd "${srcdir}/spl-0.7.9"
    ./autogen.sh
    ./configure --prefix=/usr --libdir=/usr/lib --sbindir=/usr/bin \
                --with-linux=/usr/lib/modules/4.16.9-1-hardened/build \
                --with-linux-obj=/usr/lib/modules/4.16.9-1-hardened/build \
                --with-config=kernel
    make
}
...
package_spl-linux-hardened-headers() {
    ...
    sed -i "s+${srcdir}++" ${pkgdir}/usr/src/spl-*/4.16.9-1-hardened/Module.symvers
}
