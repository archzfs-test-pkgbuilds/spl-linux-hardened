...
pkgrel=1
makedepends=("linux-hardened-headers=4.17.5.a-1")
arch=("x86_64")
...
license=("GPL")
depends=("spl-utils-common=0.7.9" "kmod" "linux-hardened=4.17.5.a-1")
...
package_spl-linux-hardened-headers() {
    ...
    sed -i "s+${srcdir}++" ${pkgdir}/usr/src/spl-*/4.17.5-1-hardened/Module.symvers
}
